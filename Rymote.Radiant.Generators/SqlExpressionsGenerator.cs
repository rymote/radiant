...
public sealed class SqlExpressionsGenerator : IIncrementalGenerator
{
    ...
    private static string GenerateSqlExpressionHelpers()
    {
        ...
        sourceBuilder.AppendLine("            JsonbExpression.PathExists(column, jsonPath);");
        sourceBuilder.AppendLine();
        ...
        sourceBuilder.AppendLine("            VectorExpression.CosineSimilarity(column, vector);");
        sourceBuilder.AppendLine("    }");
        sourceBuilder.AppendLine();
        ...
        sourceBuilder.AppendLine("            new LiteralExpression((object?)null);");
        sourceBuilder.AppendLine("    }");
